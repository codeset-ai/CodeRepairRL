...
class TestReasoningRewards(unittest.TestCase):
    ...
    def test_strict_reasoning_format_reward_func(self):
        ...
        rewards = strict_reasoning_format_reward_func(None, valid_completion)
        ...
        rewards = strict_reasoning_format_reward_func(None, invalid_completion1)
        ...
        rewards = strict_reasoning_format_reward_func(None, invalid_completion2)
        self.assertEqual(rewards, [0.0])
        ...
        rewards = strict_reasoning_format_reward_func(None, completions)
    ...
    def test_partial_reasoning_format_reward_func(self):
        ...
        rewards = partial_reasoning_format_reward_func(None, completions)
    ...
    def test_reward_function_empty_completions(self):
        ...
        self.assertEqual(partial_reasoning_format_reward_func(None, empty_completions), [])
        self.assertEqual(strict_reasoning_format_reward_func(None, empty_completions), [])
